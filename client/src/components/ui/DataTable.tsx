...
export function ExportExcelButton({
  ...
  return (
    <button
      ...
      className="inline-flex items-center justify-center gap-1.5 rounded-[10px] border-[1.5px] border-[#005BAC] bg-white text-[#005BAC] px-4 py-2.5 text-sm font-bold hover:bg-[#F0F7FC] w-full sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed"
    >
